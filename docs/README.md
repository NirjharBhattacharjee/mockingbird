...
You need a Mac with Apple Silicon, [Homebrew](https://brew.sh), and about 5 GB of
free space.
...
curl -fL -o ~/.mockingbird/models/ggml-large-v3-turbo-q8_0.bin \
...
| `MOCKINGBIRD_ASR_MODEL` (a file in `models/`, or a path) | `ggml-large-v3-turbo-q8_0.bin` |
